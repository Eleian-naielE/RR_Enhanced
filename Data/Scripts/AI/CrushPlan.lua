...
function Definitions()
    ...
    RequiredCategories = {"Infantry", "Vehicle", "AntiBomber", "Frigate", "Capital | SuperCapital"} --Must have at least one ground unit, also make sure space force is reasonable
...
function GroundForce_Thread()
    ...
    if Invade(GroundForce) == false then
		GroundForce.Move_To(FindTarget.Reachable_Target(PlayerObject, "One", "Friendly", "Friendly_Only", 1.0, Target))
